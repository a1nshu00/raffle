                ...
                <div class="account-settings-container layout-top-spacing">
                    <div class="account-content">
                        <div class="scrollspy-example" data-spy="scroll" data-target="#account-settings-scroll" data-offset="-100">
                            ...
                            <!-- General info  -->
                            <form id="raffle_form" class="" method="POST" action="{{route('raffle-draw.store')}}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input name="draw_title" placeholder="Draw Title" value="{{ old('draw_title') }}" id="draw_title" class="form-control">
                                                                        @error('draw_title')
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-6">
                                                                    <div class="form-group">
                                                                        <label for="type">Draw Type</label>
                                                                            ...
                                                                            <option value="Raffle" {{old('type') == 'Raffle' ? 'checked' : '' }} >Raffle</option>
                                                                            <option value="Ending" {{old('type') == 'Ending' ? 'checked' : '' }} >Ending</option>
                                                                        </select>
                                                                        @error('type')
                                                                            <span class="invalid-feedback" role="alert" style="display:block;">
                                                                                <strong>{{ $message }}</strong>
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text"  class="form-control"  id="total_balls" placeholder="Total Balls" value="{{ old('total_balls')  }}" name="total_balls">
                                                                        @error('total_balls')
                                                                            <span class="invalid-feedback" role="alert" style="display:block;">
                                                                                <strong>{{ $message }}</strong>
                                                                            </span>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" value="{{ old('buying_amount') }}" class="form-control"  id="buying_amount" placeholder="Buying Amount" name="buying_amount" >
                                                                        @error('buying_amount')
                                                                            <span class="invalid-feedback" role="alert" style="display:block;">
                                                                                <strong>{{ $message }}</strong>
                                                                            </span>
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="datetime-local"  min="<?php new DateTime(); ?>" value="{{ old('draw_time') }}" class="form-control"  id="draw_time" placeholder="Draw Time" name="draw_time" >
                                                                        @error('draw_time')
                                                                            <span class="invalid-feedback" role="alert" style="display:block;">
                                                                                <strong>{{ $message }}</strong>
                                                                            </span>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control"  id="streaming_link" placeholder="Streaming Link" name="streaming_link" value="{{ old('streaming_link') }}" >

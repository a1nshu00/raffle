        ...
        <div id="content" class="main-content">
            <div class="layout-px-spacing">
                ...
                <div class="account-settings-container layout-top-spacing">
                    <form id="general-info" class="section general-info" method="POST" action="{{route('user-management.update',$user->id)}}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control "  id="name" placeholder="First Name" name="first_name" value="{{$user->first_name}}">
                                                                            @error('first_name')
                                                                                <span class="invalid-feedback" role="alert" style="display:block;">
                                                                                    <strong>{{ $message }}</strong>
                                                                                </span>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" value="{{ $user->phone_number }}" class="form-control "  id="phone_number" placeholder="Phone Number" name="phone_number" >
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text"  value="{{ $user->viber }}" class="form-control "  id="viber" name="viber" placeholder="Viber">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            <label for="fb_messenger">FB Messenger</label>
                                                                            <input id="fb_messenger"  value="{{ $user->fb_messenger }}" type="text" class="form-control " name="fb_messenger" placeholder="FB Messenger">
                                                                        </div>
                                                                    </div>
                                                                </div>

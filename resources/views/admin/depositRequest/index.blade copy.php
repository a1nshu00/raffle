                    ...
                    <div class="general-info">
                       <div class="info filterform">
                           <form action="{{route('deposit-request')}}" method="get" id="fltr_frm">
                                ...
                                <input type="hidden" name="tab_active" id="tb_act" value="{{@$_GET['tab_active'] ?  @$_GET['tab_active'] : '#approve'}}">
                                <div class="row">
                               ...
                               <div class="row">
                                   <div class="col-lg-3 col-md-3">
                                    ...
                                    <div class="col-lg-4 col-md-4">
                                        <div class="form-group">
                                            <label for="">Total Approved Deposit Amount</label>
                                            <span>${{$ttl_deposit_amount}}</span>
                                        </div>
                                    </div>
                    ...
                    <div class="section general-info">
                        <div class="info tabdesign">
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item">
                                  <a class="nav-link {{$tab_active ? ($tab_active == '#approve') ? 'active' : ''  : 'active'}} tabs_btn" data-toggle="tab" href="#approve">Pending</a>
                                </li>
                                <li class="nav-item">
                              ...
                              <div class="tab-content">
                                <div id="approve" class="tab-pane {{$tab_active ? ($tab_active == '#approve') ? 'active' : ''  : 'active'}}">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="depostRequestManagement">
                                            ...
                                            <tbody>
                                                @if(count($deposit_request) > 0)
                                                    @foreach($deposit_request as $key => $value)
                                                        <tr>
...
<script>
    $(document).ready(function() {
        ...
        var dataTable = $('#depostRequestManagement').DataTable({
        });
        var dataTable = $('#depostRequestManagement_rejected').DataTable({
        });
